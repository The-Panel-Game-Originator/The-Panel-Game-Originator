...
public class BeginTest extends JPanel {
	...
	public void makeGUI()
	{
		...
		lblCourseName.setFont(new Font("sans serif", Font.BOLD, 20));
		lblCourseName.setBounds(10, 26, 382, 34);
		add(lblCourseName);
		//addTimer
		
		c=new Clock(HH,MM,SS);
		c.setBounds(720,11,266, 60);
		add(c);
		//add QuestionPanel
		...
		btnSubmit.setFont(new Font("sans serif", Font.BOLD, 25));
		btnSubmit.setBackground(new Color(98, 113, 202));
