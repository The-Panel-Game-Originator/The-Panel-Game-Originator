...
public class QuestionPanel extends JPanel implements ActionListener{
	...
	{
		try{
			Statement s=c.con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
	...
	private void ResultManagement()
	{
			...
			try {
				if(rs.next())
				{
					...
					Previous.setBackground(new Color(98, 113, 202));
					Previous.setFont(new Font("sans serif", Font.BOLD, 18));
					...
					Next.setBackground(new Color(4, 252, 96));
					Next.setForeground(Color.WHITE);
					Next.setFont(new Font("sans serif", Font.BOLD, 18));
...
//									Next.setText("FIRST");
	...
	private void makeQuestionVisible(String q_id)
	{
		...
		question_statement.setLineWrap(true);
		question_statement.setFont(new Font("Gisha", Font.PLAIN, 14));
