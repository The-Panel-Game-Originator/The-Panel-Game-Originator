...
class Run extends JPanel implements Runnable
{
	...
	public void makeGUI(String txt) {
		setLayout(null);
		setBackground(new Color(20, 15, 59));
		JLabel lblXxxxxx = new JLabel(txt);
		lblXxxxxx.setBackground(new Color(20, 15, 59));
		lblXxxxxx.setForeground(Color.WHITE);//(new Color(148, 0, 211));
		lblXxxxxx.setHorizontalAlignment(SwingConstants.LEFT);
		lblXxxxxx.setFont(new Font("Times Roman", Font.BOLD, 18));
		lblXxxxxx.setBounds(20, 0, 266, 60);
		add(lblXxxxxx);
		repaint();
		revalidate();
		try {
