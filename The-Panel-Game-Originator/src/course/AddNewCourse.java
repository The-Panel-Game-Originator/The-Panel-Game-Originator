...
public class AddNewCourse extends JPanel implements FocusListener {
	...
	private boolean addCourse(String courseName,String time)
	{
		...
		try{
			String query="INSERT INTO course_details (course_name,time,date_of_creation,question_mark,total_question) VALUES(?,?,current_timestamp,?,0)";
	...
	public AddNewCourse() {
		...
		lblEachMark.setFont(new Font("sans serif", Font.BOLD, 18));
		...
		btnShowCourse.setForeground(Color.WHITE);
		btnShowCourse.setFont(new Font("sans serif", Font.BOLD, 18));
		btnShowCourse.setBounds(472, 417, 256, 36);
		btnShowCourse.setBackground(new Color(4, 252, 96));
		add(btnShowCourse);
