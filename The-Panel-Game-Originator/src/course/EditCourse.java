...
public class EditCourse extends JPanel implements ItemListener{
	...
	public EditCourse(String courseName) {
		...
		lblTotalQuestions.setForeground(Color.WHITE);
		...
		back.setBackground(new Color(219, 51, 13));
		add(back);
		...
		lblEachMark.setForeground(Color.WHITE);
		...
		lblCourseName.setFont(new Font("sans serif", Font.BOLD, 12));
		lblCourseName.setBounds(781, 113, 87, 24);
		add(lblCourseName);
		save.setFont(new Font("sans serif", Font.BOLD, 18));
		save.setBackground(new Color(4, 252, 96));
		...
		lblOnlineExamination.setFont(new Font("sans sarif", Font.BOLD, 41));
		add(lblOnlineExamination);
		
		JCheckBox chckbxHide = new JCheckBox("HIDE");
		chckbxHide.setOpaque(false);
		chckbxHide.setForeground(Color.WHITE);
	...
	private JPanel New()
	{
		...
		btnSave.setFont(new Font("sans sarif", Font.PLAIN, 18));
		btnSave.setBackground(new Color(98, 113, 202));
