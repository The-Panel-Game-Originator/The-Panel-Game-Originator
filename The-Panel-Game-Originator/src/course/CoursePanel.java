...
//		SelectedCourse=CD.Courses[0];
		...
		btnViewCourse.setBackground(new Color(98, 113, 202));
		btnViewCourse.setFont(new Font("sans sarif", Font.BOLD, 18));
		...
		btnDeleteCourse.setBackground(new Color(219, 51, 13));
		btnDeleteCourse.setFont(new Font("sans serif", Font.BOLD, 18));
		...
		btnAddNewCourse.setBackground(new Color(4, 252, 96));
		btnAddNewCourse.setFont(new Font("sans serif", Font.BOLD, 18));
