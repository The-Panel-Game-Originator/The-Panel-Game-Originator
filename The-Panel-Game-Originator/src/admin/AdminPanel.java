...
public class AdminPanel extends JPanel implements FocusListener{
	...
	public AdminPanel() {
		...
		pwdPassword.setFont(new Font("sans serif", Font.BOLD, 18));
		pwdPassword.setText("Password");
		pwdPassword.setBounds(345, 191, 300, 40);
		add(pwdPassword);
		...
		txtUsername.setFont(new Font("sans serif", Font.BOLD, 18));
		txtUsername.setText("USERNAME");
		txtUsername.setBounds(345, 137, 300, 40);
		add(txtUsername);
		...
		JLabel lblOnlineExamination = new JLabel("ADMINLOGIN");
