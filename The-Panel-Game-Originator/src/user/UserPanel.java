...
public class UserPanel extends JPanel {
	...
	public UserPanel(String username) {
		...
		btnResult.setFont(new Font("sans serif", Font.BOLD, 18));
		btnResult.setBounds(815, 64, 166, 42);
		btnResult.setBackground(new Color(4, 252, 96));
		add(btnResult);
		btnStartTest.setBorder(new LineBorder(new Color(0, 255, 0), 3, true));
		btnStartTest.setBackground(new Color(219, 51, 13));
		btnStartTest.setForeground(Color.WHITE);
		btnStartTest.setFont(new Font("sans serif", Font.BOLD, 18));
		...
		instructions.setBackground(new Color(68, 64, 107));
		instructions.setFont(new Font("sans serif", Font.BOLD, 18));
		...
		lblSelectCourse.setFont(new Font("sans serif", Font.BOLD, 20));
		...
		btnEditDetails.setFont(new Font("sans serif", Font.BOLD, 18));
		btnEditDetails.setBounds(815, 11, 166, 42);
		btnEditDetails.setBackground(new Color(4, 252, 96));
		add(btnEditDetails);
		...
		btnLogout.setFont(new Font("sans serif", Font.BOLD, 18));
		btnLogout.setBackground(new Color(98, 113, 202));
		btnLogout.setBounds(10, 11, 152, 36);
		add(btnLogout);
		
		JLabel WlecomeLabel = new JLabel("WELCOME "+Name);
		WlecomeLabel.setForeground(Color.WHITE);
		WlecomeLabel.setFont(new Font("sans serif", Font.BOLD, 21));
