...
public class RegistrationForm extends JPanel implements ActionListener {
	...
	public RegistrationForm() {
		...
		submit.setBackground(new Color(4, 252, 96));
		add(submit);
		...
		reset.setBackground(new Color(219, 51, 13));
		...
		back.setBackground(new Color(98, 113, 202));
	...
	public RegistrationForm(EditDetails e) {
		...
		label_2.setFont(new Font("sans serif", Font.BOLD, 13));
		...
		submit.setForeground(Color.WHITE);
		submit.setFont(new Font("sans serif", Font.BOLD, 13));
		submit.setBackground(new Color(4, 252, 96));
		...
		back.setFont(new Font("snas serif", Font.BOLD, 18));
		add(back);
